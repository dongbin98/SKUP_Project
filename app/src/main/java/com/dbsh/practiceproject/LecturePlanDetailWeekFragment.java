...
public class LecturePlanDetailWeekFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        networkTask = new NetworkTask(rootView, token, id, year, term, cd, cn, pi);
        networkTask.execute();

        return rootView;
    }

    public class NetworkTask extends AsyncTask<Void, Void, ArrayList<ArrayList<String>>> {
        ViewGroup rootView;
        String token;
        String id;
        String year;
        ...
        public NetworkTask(ViewGroup rootView, String token, String id, String year, String term, String cd, String cn, String pi) {
        ...
        protected ArrayList<ArrayList<String>> doInBackground(Void... params) {
            result = getWeekInfo(token, id, year, term, cd, cn, pi);
            return result;
        }
    ...
    public ArrayList<ArrayList<String>> getWeekInfo(String token, String id, String year, String term, String cd, String cn, String pi) {
        try {
            // ----------------------------
            // URL 설정 및 접속
            // ----------------------------
